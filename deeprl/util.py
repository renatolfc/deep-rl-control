...
def get_executable_path():
    ...
    if platform.system() == 'Linux':
        if '64' in platform.architecture()[0]:
            return os.path.join(parent, 'Reacher_Linux', 'Reacher.x86_64')
        else:
            return os.path.join(parent, 'Reacher_Linux', 'Reacher.x86')
    elif platform.system() == 'Darwin':
            return os.path.join(parent, 'Reacher.app')
    elif platform.system() == 'Windows':
        if '64' in platform.architecture()[0]:
            return os.path.join(parent, 'Reacher_Windows_x86_64', 'Reacher.exe')
        else:
            return os.path.join(parent, 'Reacher_Windows_x86', 'Reacher.exe')
    else:
